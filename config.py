...
APP_ID = int(os.environ.get("APP_ID", "12345")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001234567890")) #Your db channel Id
OWNER = os.environ.get("OWNER", "owner") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "123456789")) # Owner id
#--------------------------------------------
...
"""
#--------------------------------------------
# Custom caption with placeholders for file info
# Available placeholders: {previouscaption}, {filename}
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "{previouscaption}\n\n<b>📁 File: {filename}</b>\n<b>🤖 Shared via FileStore Bot</b>") #set your Custom Caption here, Keep None for Disable Custom Caption
